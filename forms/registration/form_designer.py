...
class FormRegisterDesigner():       
    ...
    def __init__(self):
        ...
        logo = utl.leer_imagen("./imagenes/LogoTienda.webp", (150, 150))
        # frame_logo
        frame_logo = tk.Frame(self.ventana, bd=0, width=200,
                              relief=tk.SOLID, padx=10, pady=10, bg='#e4e4e4')
        ...
        title = tk.Label(frame_form_top, text="Registro de usuario", font=(
            'Times', 30), fg="black", bg='#F87474', pady=30)
        title.pack(expand=tk.YES, fill=tk.BOTH)
        # end frame_form_top

        # frame_form_fill
        frame_form_fill = tk.Frame(
            frame_form, height=50,  bd=0, relief=tk.SOLID, bg='#F87474')
        frame_form_fill.pack(side="bottom", expand=tk.YES, fill=tk.BOTH)

        etiqueta_usuario = tk.Label(frame_form_fill, text="Usuario", font=(
            'Times', 14), fg="black", bg='#F87474', anchor="w")
